...
Для решения задачи необходимо предварительное исследование данных и сформулровать, что должно считаться покупкой.  Выбор можно обосновать с помощью фактов оплат, статусов заказов и других имеющихся данных.
